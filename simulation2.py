...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec  9 20:18:53 2019
...
#radius_l=5*0.1 #radius of ligands
radius_l=2

n2 = 8 #the amount of receptors

radius_r=20*0.1 #radius of receptor
L = 1000*0.1  #the length and width of the box
...
rx_r=[50.0,10.0,50.0,90.0,21.7,21.7,78.3,78.3]
ry_r=[10.0,50.0,90.0,50.0,21.7,78.3,78.3,21.7]
...
def force():
    ...
    for i in range(n1-1):
        for j in range(i+1, n1):
            ...
            fy[j] -= fy1+fy2+fy4
            '''
            fx[i] += fx1+fx4  #the values of interaction force 
            fx[j] -= fx1+fx4 #are the same with opposite direction
            fy[i] += fy1+fy4  #between two particles
            fy[j] -= fy1+fy4
...
anim1.save('brow_8recep_line_ligandinter_jones_wall_small_lowc.mp4',writer=FFwriter)
''
plt.show()
''
