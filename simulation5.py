...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec  9 20:30:50 2019
...
rcharge=-200 #charge of receptor
#tt = 0
...
def force():
    ...
    for i in range(n1):
        for k in range(n2):
            ...
            #f3=(1/(4*math.pi*epsilon))*((lcharge*rcharge)/dr_r)
            sin_r=dy_r/dr_r
            cos_r=dx_r/dr_r
            fx3=f3*cos_r
            fy3=f3*sin_r
...
anim1.save('brow_8recep_line_only_rece.mp4',writer=FFwriter)
''
plt.show()
''
